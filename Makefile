...
#    Updated: 2026/02/01 17:02:36 by yademirk         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
LL_SRC = ft_lstadd_back.c ft_lstadd_front.c ft_lstadd_sorted.c ft_lstclear.c ft_lstdelone.c ft_lstdel_node.c ft_lst_replace.c ft_lstiter.c ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c ft_lst_to_string_arr.c
